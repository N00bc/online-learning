package com.cyn.onlinelearning.generator;
...
//			 "course_publish_pre"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/online-learning-generator/src/main/java");
		gc.setAuthor("godc");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://myvm:3306/online-learning_" + SERVICE_NAME);
